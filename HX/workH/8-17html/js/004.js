 ...
 *     Description: 拼图游戏
 *     ChangeTime : 2017-08-16  21:44:34
 *
 *****************************************
*/
...
// 鼠标拖动事件（包含边界条件）
	function moveMouse(obj,a,b,c,d){
		...
		obj.onmouseup=function(){
			...
			console.log(y2);	
				if(dx==0){
					console.log(dx);
						...
						// kj("#img5").style.left=xx;
						// kj("#img5").style.top=yy;
			...
			// aaa(kj("#img7"),kj("#img8"),kj("#img9"));

			// function aaa(a,b,c){
			// 	if(y2<=396 && y2>=264){	
			// 	if(dx==0){
			// 			var xx = getStyle(a,"background");
			// 			 a.style.background=getStyle(this,"background");
			// 			this.style.background=xx;
			// 			console.log(getStyle(this,"background"));
			// 		}else if(dx==1){
			// 			var tt = getStyle(b,"background");
			// 			b.style.background=getStyle(this,"background");
			// 			this.style.background=tt;
			// 			console.log(getStyle(this,"background"));
			// 		}else if(dx==2){
			// 			var vv = getStyle(c,"background");
			// 			c.style.background=getStyle(this,"background");
			// 			this.style.background=vv;
			// 			console.log(getStyle(this,"background"));
			// 	}
			// }
